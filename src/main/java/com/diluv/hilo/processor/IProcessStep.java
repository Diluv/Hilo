...
public interface IProcessStep {
     ...
     */
    void process (Logger log, FileData data, ProjectFileRecord queueData, Path workingDir, Path file, String extension) throws Exception;
     ...
     *     procedure will end and report that the procedure failed.
     */
    boolean validate (Logger log, FileData data, ProjectFileRecord queueData, Path file, String extension) throws Exception;
}