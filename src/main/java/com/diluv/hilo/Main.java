...
public class Main {
    ...
    public static final Hilo HILO = new Hilo(8, new ProcessingProcedure(ProcessStepGZip.INSTANCE, new ProcessStepClamAV(CLAM), new ProcessStepASC(Constants.SIGNING_KEY, Constants.PGP_PASS)));
